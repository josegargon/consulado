...
?>
	...
	<div class="container container_12">
		...
		<div class="content full alignleft">
			...
			$query_args = array( 'post_type' => 'staff', 'order' => 'asc' );
				 ...
				 ?>
					...
					<div class="staff grid_4 rounded_2 alignleft">
						...
						<?php if ( has_post_thumbnail() ) : ?>
							<a href="<?php the_permalink(); ?>" class="pose"> 
								<img src="<?php echo vz_resize( get_post_thumbnail_id(get_the_ID()), 'vz_about_staff'); ?>" class="rounded_2" />
							</a>
						<?php endif; ?>

						<div class="description"> <?php echo substr(str_replace('[...]', '', get_the_excerpt()),0,280); ?> </div>
